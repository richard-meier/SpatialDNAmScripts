...
tca_like_model_flip_custom_prior = function(){
...
tca_like_model_flip_custom_prior2 = function(){
...
berry_like_model_m2_custom_prior = function(){
...
berry_like_model_m2_custom_prior2 = function(){
